...
export type GenericMorph = ComponentSeoSeo | ComponentSharedMetaSocial | ComponentSharedSeo | I18NLocale | Test | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type Test = {
  ...
  createdAt?: Maybe<Scalars['DateTime']['output']>;
  ga?: Maybe<UploadFileRelationResponseCollection>;
...
export type TestInput = {
  asd?: InputMaybe<Scalars['String']['input']>;
  ga?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
